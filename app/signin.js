            ...
            <View className="gap-10">
                ...
                <View className="gap-4">
                    ...
                    <View className="gap-3">
                        ...
                        <Text style={{fontSize: hp(1.8)}} className="text-right text-neutral-500 font-semibold">Forgot Password?</Text> 
                    </View>
                    {/*Submit Button */}
                    <View>
                        {loading ? (
                            ...
                            <TouchableOpacity onPress={handleLogin} style={{fontSize: hp(6.5)}} className="bg-indigo-500 py-3 rounded-xl justify-center items-center">
